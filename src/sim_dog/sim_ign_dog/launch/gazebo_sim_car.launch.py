...
def generate_launch_description():
    ...
    ros_bridge_node = Node(
        ...
        arguments=[
            ...
            '/model/go2_dog/odometry@nav_msgs/msg/Odometry[gz.msgs.Odometry',#odom 里程计消息
            '/model/go2_dog/tf@tf2_msgs/msg/TFMessage[gz.msgs.Pose_V',#tf消息
            '/world/empty/model/go2_dog/joint_state@sensor_msgs/msg/JointState[gz.msgs.Model',#关节状态
        ...
        remappings=[
            ('/model/go2_dog/odometry', '/odom'),
            ('/model/go2_dog/tf', '/tf'),
            ('/world/empty/model/go2_dog/joint_state', '/joint_states'),
        ]
    )
